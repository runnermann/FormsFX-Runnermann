...
import habanero.edu.rice.pcdp.runtime.MultiException;
...
public abstract class BaseTask extends CountedCompleter<Void> {
       ...
       * @author Shams Imam (shams@rice.edu)
       */
      public static final class FinishTask extends habanero.edu.rice.pcdp.runtime.BaseTask {
       ...
       * @author Shams Imam (shams@rice.edu)
       */
      public static final class FutureTask<R> extends habanero.edu.rice.pcdp.runtime.BaseTask {
