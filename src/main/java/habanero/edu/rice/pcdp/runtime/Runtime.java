package habanero.edu.rice.pcdp.runtime;

import habanero.edu.rice.pcdp.config.Configuration;
...
public final class Runtime {
      ...
      public static BaseTask currentTask() {
            final Deque<BaseTask> taskStack = habanero.edu.rice.pcdp.runtime.Runtime.threadLocalTaskStack.get();
      ...
      public static void pushTask(final BaseTask task) {
            habanero.edu.rice.pcdp.runtime.Runtime.threadLocalTaskStack.get().push(task);
      }
      ...
      public static void popTask() {
            habanero.edu.rice.pcdp.runtime.Runtime.threadLocalTaskStack.get().pop();
      }
