...
import richtextfm.model.SegmentOps;
...
public interface TextEditingArea<PS, SEG, S> {
    ...
    /**
     * See {@link richtextfm.model.EditableStyledDocument#multiPlainChanges()}
     */
    EventStream<List<PlainTextChange>> multiPlainChanges();

    /**
     * See {@link richtextfm.model.EditableStyledDocument#plainChanges()}
     */
    EventStream<PlainTextChange> plainTextChanges();

    /**
     * See {@link richtextfm.model.EditableStyledDocument#multiRichChanges()}
     */
    EventStream<List<RichTextChange<PS, SEG, S>>> multiRichChanges();

    /**
     * See {@link richtextfm.model.EditableStyledDocument#richChanges()}
     */
