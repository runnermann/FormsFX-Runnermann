...
public class ChargeSkin extends GaugeSkinBase {
      ...
      private final Region[] bars;
      private final Background[] barBackgrounds;
      ...
      private final ChangeListener<Number> paneWidthListener;
      ...
      public ChargeSkin(Gauge gauge) {
            ...
            paneWidthListener = (o, ov, nv) -> {
                  if (ov.intValue() == 0 && nv.intValue() > 0) Platform.runLater(() -> resize());
            };
      ...
      protected void resize() {
            ...
            if (width > 0 && height > 0) {
                  ...
                  for (int i = 0; i < 12; i++) {
                        ...
                        barBackgrounds[i] = new Background(new BackgroundFill(Color.WHITE, new CornerRadii(1024), Insets.EMPTY),
                        ...
                        barBackgrounds[i + 12] = new Background(new BackgroundFill(Color.WHITE, new CornerRadii(1024), Insets.EMPTY),
