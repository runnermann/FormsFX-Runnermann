...
public class BulletChartSkin extends GaugeSkinBase {
      ...
      private final Tooltip barTooltip;
      private final Tooltip thresholdTooltip;
      ...
      private final InvalidationListener paneSizeListener;
      ...
      protected void resize() {
            ...
            if (Orientation.VERTICAL == orientation) {
                  ...
                  if (titleText.getLayoutBounds().getWidth() > maxTextWidth) {
                        Helper.adjustTextSize(titleText, maxTextWidth, 0.24 * width);
                  }
                  ...
                  if (unitText.getLayoutBounds().getWidth() > maxTextWidth) {
                        Helper.adjustTextSize(unitText, maxTextWidth, 0.15 * width);
                  }
