...
import gaugeLib.hansolo.medusa.tools.Statistics;
...
public class TileSparklineSkin extends GaugeSkinBase {
      ...
      private final InvalidationListener averagingListener;
      ...
      protected void handleEvents(final String EVENT_TYPE) {
            ...
            if ("RECALC".equals(EVENT_TYPE)) {
                  ...
                  if (!gauge.isAveragingEnabled()) {
                        gauge.setAveragingEnabled(true);
                  }
      ...
      private void resizeDynamicText() {
            ...
            if (highText.getLayoutBounds().getWidth() > maxWidth) {
            ...
            if (lowText.getLayoutBounds().getWidth() > maxWidth) {
