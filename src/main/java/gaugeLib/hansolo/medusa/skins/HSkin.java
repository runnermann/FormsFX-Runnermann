...
public class HSkin extends GaugeSkinBase {
      ...
      private double getStartAngle() {
            ...
            switch (knobPosition) {
                  case TOP_CENTER:
                        return ScaleDirection.CLOCKWISE == scaleDirection ? angleRange * 0.5 : -angleRange * 0.5;
                  case BOTTOM_CENTER:
                  default:
                        return ScaleDirection.CLOCKWISE == scaleDirection ? 180 + angleRange * 0.5 : 180 - angleRange * 0.5;
            }
      }
      ...
      private void drawGradientBar() {
            ...
            for (Stop stop : stops) {
                  stopAngleMap.put(stop.getOffset() * angleRange, stop.getColor());
            }
