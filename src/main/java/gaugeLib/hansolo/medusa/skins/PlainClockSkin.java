...
public class PlainClockSkin extends ClockSkinBase {
      ...
      public void updateTime(final ZonedDateTime TIME) {
            ...
            if (highlightAreas | highlightSections) {
                  ...
                  if (areasVisible)
                        Helper.drawTimeAreas(clock, sectionsAndAreasCtx, areas, size, 0.025, 0.025, 0.95, 0.95);
                  if (sectionsVisible)
                        Helper.drawTimeSections(clock, sectionsAndAreasCtx, sections, size, 0.06, 0.06, 0.88, 0.88, 0.07);
            }
      }
