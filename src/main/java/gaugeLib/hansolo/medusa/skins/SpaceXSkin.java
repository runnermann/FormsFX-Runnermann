...
public class SpaceXSkin extends GaugeSkinBase {
      ...
      private void setBar(final double VALUE) {
            ...
            if (valueText.getLayoutBounds().getWidth() > 0.64 * width)
                  Helper.adjustTextSize(valueText, width, 0.21 * width);
      ...
      protected void resize() {
            ...
            if (width > 0 && height > 0) {
                  ...
                  if (titleText.getLayoutBounds().getWidth() > width)
                        Helper.adjustTextSize(titleText, width, 0.13 * width);
                  ...
                  if (unitText.getLayoutBounds().getWidth() > 0.4 * width)
                        Helper.adjustTextSize(unitText, width, 0.11 * width);
