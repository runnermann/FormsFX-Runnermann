...
public class IndicatorSkin extends GaugeSkinBase {
      ...
      private final boolean sectionsAlwaysVisible;
      ...
      private final InvalidationListener sectionAlwaysVisibleListener;
      ...
      private void resizeStaticText() {
            ...
            if (minValueText.getLayoutBounds().getWidth() > maxWidth) {
                  Helper.adjustTextSize(minValueText, maxWidth, fontSize);
            }
