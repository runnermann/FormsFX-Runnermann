...
import gaugeLib.hansolo.medusa.Alarm;
import gaugeLib.hansolo.medusa.Clock;
import gaugeLib.hansolo.medusa.Fonts;
import gaugeLib.hansolo.medusa.TimeSection;
...
public class DBClockSkin extends ClockSkinBase {
      ...
      private final Map<Alarm, Circle> alarmMap = new ConcurrentHashMap<>();
      private double size;
      ...
      public void updateTime(final ZonedDateTime TIME) {
            ...
            if (highlightAreas | highlightSections) {
                  ...
                  if (areasVisible)
                        Helper.drawTimeAreas(clock, sectionsAndAreasCtx, areas, size, 0.035, 0.035, 0.93, 0.93);
                  if (sectionsVisible)
                        Helper.drawTimeSections(clock, sectionsAndAreasCtx, sections, size, 0.056, 0.056, 0.89, 0.89, 0.0395);
            }
      }
