...
import static gaugeLib.hansolo.medusa.tools.Helper.clamp;
...
public class TileTextKpiSkin extends GaugeSkinBase {
      ...
      private final boolean sectionsVisible;
      ...
      private void resizeStaticText() {
            ...
            if (percentageText.getLayoutBounds().getWidth() > maxWidth) {
                  Helper.adjustTextSize(percentageText, maxWidth, fontSize);
            }
            ...
            if (maxValueUnitText.getLayoutBounds().getWidth() > maxWidth) {
                  Helper.adjustTextSize(maxValueUnitText, maxWidth, fontSize);
            }
            ...
            if (maxValueText.getLayoutBounds().getWidth() > maxWidth) {
                  Helper.adjustTextSize(maxValueText, maxWidth, fontSize);
            }
            if (unitText.isVisible()) {
