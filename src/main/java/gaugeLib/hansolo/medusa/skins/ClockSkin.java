...
public class ClockSkin extends ClockSkinBase {
      ...
      public void updateTime(final ZonedDateTime TIME) {
            ...
            if (highlightAreas | highlightSections) {
                  ...
                  if (areasVisible)
                        Helper.drawTimeAreas(getSkinnable(), sectionsAndAreasCtx, areas, size, 0.03, 0.03, 0.94, 0.94);
                  if (sectionsVisible)
                        Helper.drawTimeSections(getSkinnable(), sectionsAndAreasCtx, sections, size, 0.065, 0.065, 0.87, 0.87, 0.07);
            }
      }
