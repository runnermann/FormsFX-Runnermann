...
import gaugeLib.hansolo.medusa.LcdFont;
...
public class LcdSkin extends GaugeSkinBase {
      ...
      private static final Text oneSegment = new Text("8");
      private static final Text dotSegment = new Text(".");
      ...
      private final StringBuilder backgroundTextBuilder;
      private Group shadowGroup;
      private String valueFormatString;
      private String otherFormatString;
      private Locale locale;
      private List<Section> sections;
      private final Map<Section, Color[]> sectionColorMap;
      ...
      protected void redraw() {
            ...
            if (gauge.isThresholdVisible()) {
                  threshold.setVisible(Double.compare(gauge.getCurrentValue(), gauge.getThreshold()) >= 0);
            }
