...
import gaugeLib.hansolo.medusa.skins.*;
import gaugeLib.hansolo.medusa.tools.Data;
import gaugeLib.hansolo.medusa.tools.GradientLookup;
import gaugeLib.hansolo.medusa.tools.Helper;
import gaugeLib.hansolo.medusa.tools.MarkerComparator;
import gaugeLib.hansolo.medusa.tools.MovingAverage;
import gaugeLib.hansolo.medusa.tools.SectionComparator;
...
public class Gauge extends Control {
      ...
      public ObjectProperty<NeedleBehavior> needleBehaviorProperty() {
            if (null == needleBehavior) {
                  needleBehavior = new ObjectPropertyBase<NeedleBehavior>(_needleBehavior) {
                        @Override
                        protected void invalidated() {
                              if (null == get()) set(NeedleBehavior.STANDARD);
                        }
      ...
      public BooleanProperty checkSectionsForValueProperty() {
            if (null == checkSectionsForValue) {
                  checkSectionsForValue = new SimpleBooleanProperty(Gauge.this, "checkSectionsForValue", _checkSectionsForValue);
            }
      ...
      @Override
      public String getUserAgentStylesheet() //throws NullPointerException
      {
            String resource = "";
            try {
