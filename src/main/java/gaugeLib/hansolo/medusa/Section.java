...
public class Section implements Comparable<Section> {
      ...
      public final ObjectProperty<EventHandler<SectionEvent>> onSectionEnteredProperty() {
            return onSectionEntered;
      }

      public final void setOnSectionEntered(EventHandler<SectionEvent> value) {
            onSectionEnteredProperty().set(value);
      }

      public final EventHandler<SectionEvent> getOnSectionEntered() {
            return onSectionEnteredProperty().get();
      }

      private final ObjectProperty<EventHandler<SectionEvent>> onSectionEntered = new SimpleObjectProperty<>(this, "onSectionEntered");

      public final ObjectProperty<EventHandler<SectionEvent>> onSectionLeftProperty() {
            return onSectionLeft;
      }

      public final void setOnSectionLeft(EventHandler<SectionEvent> value) {
            onSectionLeftProperty().set(value);
      }

      public final EventHandler<SectionEvent> getOnSectionLeft() {
            return onSectionLeftProperty().get();
      }

      private final ObjectProperty<EventHandler<SectionEvent>> onSectionLeft = new SimpleObjectProperty<>(this, "onSectionLeft");
      ...
      public final void setOnSectionUpdate(EventHandler<SectionEvent> value) {
            onSectionUpdateProperty().set(value);
      }

      public final EventHandler<SectionEvent> getOnSectionUpdate() {
            return onSectionUpdateProperty().get();
      }

      private final ObjectProperty<EventHandler<SectionEvent>> onSectionUpdate = new SimpleObjectProperty<>(this, "onSectionUpdate");
