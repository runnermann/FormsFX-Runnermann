...
public class Marker implements Comparable<Marker> {
      ...
      public ObjectProperty<Color> colorProperty() {
            if (null == color) {
                  color = new SimpleObjectProperty<>(Marker.this, "color", _color);
            }
            return color;
      }
      ...
      public MarkerType getMarkerType() {
            return null == markerType ? _markerType : markerType.get();
      }
      ...
      public ObjectProperty<MarkerType> markerTypeProperty() {
            if (null == markerType) {
                  markerType = new ObjectPropertyBase<MarkerType>(_markerType) {
                        @Override
                        public void set(final MarkerType TYPE) {
                              super.set(null == TYPE ? MarkerType.STANDARD : TYPE);
                        }
       ...
       * @param STYLE_CLASS
       */
      public void setStyleClass(final String STYLE_CLASS) {
            styleClass = STYLE_CLASS;
      }
      ...
      private final ObjectProperty<EventHandler<MarkerEvent>> onMarkerExceeded = new SimpleObjectProperty<>(Marker.this, "onMarkerExceeded");
      ...
      private final ObjectProperty<EventHandler<MarkerEvent>> onMarkerUnderrun = new SimpleObjectProperty<>(Marker.this, "onMarkerUnderrun");
      ...
      private final ObjectProperty<EventHandler<MarkerEvent>> onValueChanged = new SimpleObjectProperty<>(Marker.this, "onValueChanged");
      ...
      public final void setOnColorChanged(EventHandler<MarkerEvent> value) {
            onColorChangedProperty().set(value);
      }
      ...
      private final ObjectProperty<EventHandler<MarkerEvent>> onColorChanged = new SimpleObjectProperty<>(Marker.this, "onColorChanged");
      ...
      public final void setOnTextChanged(EventHandler<MarkerEvent> value) {
            onTextChangedProperty().set(value);
      }

      public final EventHandler<MarkerEvent> getOnTextChanged() {
            return onTextChangedProperty().get();
      }

      private final ObjectProperty<EventHandler<MarkerEvent>> onTextChanged = new SimpleObjectProperty<>(Marker.this, "onTextChanged");
      ...
      public final void setOnTypeChanged(EventHandler<MarkerEvent> value) {
            onTypeChangedProperty().set(value);
      }

      public final EventHandler<MarkerEvent> getOnTypeChanged() {
            return onTypeChangedProperty().get();
      }

      private final ObjectProperty<EventHandler<MarkerEvent>> onTypeChanged = new SimpleObjectProperty<>(Marker.this, "onTypeChanged");

      public final ObjectProperty<EventHandler<MarkerEvent>> onMarkerPressedProperty() {
            return onMarkerPressed;
      }

      public final void setOnMarkerPressed(EventHandler<MarkerEvent> value) {
            onMarkerPressedProperty().set(value);
      }

      public final EventHandler<MarkerEvent> getOnMarkerPressed() {
            return onMarkerPressedProperty().get();
      }

      private final ObjectProperty<EventHandler<MarkerEvent>> onMarkerPressed = new SimpleObjectProperty<>(Marker.this, "onMarkerPressed");

      public final ObjectProperty<EventHandler<MarkerEvent>> onMarkerReleasedProperty() {
            return onMarkerReleased;
      }

      public final void setOnMarkerReleased(EventHandler<MarkerEvent> value) {
            onMarkerReleasedProperty().set(value);
      }

      public final EventHandler<MarkerEvent> getOnMarkerReleased() {
            return onMarkerReleasedProperty().get();
      }

      private final ObjectProperty<EventHandler<MarkerEvent>> onMarkerReleased = new SimpleObjectProperty<>(Marker.this, "onMarkerReleased");
