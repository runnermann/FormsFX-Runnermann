package brachtendorf.jimagehash.datastructures;
...
public class ClusterResult {
      ...
      private final HashMap<Integer, MutableDouble> sse = new HashMap<>();
      private final HashMap<Integer, MutableDouble> silhouetteCoef = new HashMap<>();
...
//			DoubleSummaryStatistics cStats = stats.get(i);
      ...
      public Map<Integer, Double> getPotentialFits(Hash testHash, double sigma) {
            ...
            resultValue = resultValue.entrySet().stream().sorted(Entry.comparingByValue())
