package brachtendorf.jimagehash.hashAlgorithms;
...
import brachtendorf.jimagehash.hashAlgorithms.filter.Filter;
...
public abstract class HashingAlgorithm implements Serializable {
       ...
       * <li>the returned hash's {@link BigInteger#bitCount()} value due to
      ...
      public boolean equals(Object obj) {
            ...
            if (this.opaqueReplacementThreshold >= 0 && other.opaqueReplacementThreshold >= 0) {
                  ...
                  return this.opaqueReplacementColor.equals(other.opaqueReplacementColor);
