...
//	@Override
      ...
      public String[] readTestTypes() {
            ...
            for (int i = 0, idx = 0; i < (TestList.TEST_TYPES.length - 1); i++) {
                  if (((deckTestInt >> i) & 1) == 1) {
                        testTypes.set(idx++, TestList.TEST_TYPES[i].getName());
                  }
            }
      ...
      public boolean isSellDeck() {
            return sellDeck;
      }

      public void setSellDeck(boolean sellDeck) {
            this.sellDeck = sellDeck;
      }

      public boolean isShareDistro() {
            return shareDistro;
      }

      public void setShareDistro(boolean shareDistro) {
            this.shareDistro = shareDistro;
      }
