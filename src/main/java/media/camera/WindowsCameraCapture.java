 ...
 */
public class WindowsCameraCapture extends Application {

      private static WindowsCameraCapture CLASS_INSTANCE;
      ...
      private static final Logger LOGGER = LoggerFactory.getLogger(WindowsCameraCapture.class);
      ...
      private WindowsCameraCapture() {/* no args constructor */}

      public static synchronized WindowsCameraCapture getInstance() {
            if (CLASS_INSTANCE == null) {
                  CLASS_INSTANCE = new WindowsCameraCapture();
            }
