...
//	}
	...
	public void sellSwitchAction(ToggleSwitch sellSwitch, ToggleSwitch shareSwitch) {
		if(!current()) {
			...
			boolean b = alerts.choiceOnlyActionPopup(" Advanced FlashMonkey Alert ", alerts.JOIN_OR_FAIL, "image/logo/vertical_logo_blue_480.png",
					UIColors.ICON_ELEC_BLUE);
			if(b) {
				// if true send to create subscription.
				FlashMonkeyMain.getSubscribePane();
			} else {
