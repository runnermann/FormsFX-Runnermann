...
public class SearchRemoteDescriptor implements FormData, Descriptor<SearchRemoteDescriptor> {
	...
	/* Search Form Entries */
	public String getFriendDescript() { return friend.get(); }
	public String getDeckKey() { return deckKey.get(); }
	public long   getnltDate() { return nltDate.get(); }
	public long   getnetDate() { return netDate.get(); }
	//public ListProperty getProfessors() {return professors.get(); }
	//  public String getCourseCode() { return courseCodes.get(); }
	public String getSelectedSubject() { return selectedSubject.get(); }
	
/* Search properties */
	public StringProperty friendProperty() { return friend; }
	public StringProperty deckKeyProperty() { return deckKey; }
	public LongProperty   nltDateProperty() { return nltDate; }
	public LongProperty   netDateProperty() { return netDate; }
/* search by institute and prof/course code */
	public ListProperty<String> professorsProperty() { return professors; }
	public ObjectProperty<String> selectedProfProperty() { return selectedProf; }
	public ListProperty<String> courseCodesProperty() { return courseCodes; }
	public ObjectProperty<String> SelectedCourseCodeProperty() { return selectedCourseCode; }
	...
	public String getSelectedProf() { return selectedProf.get(); }
	public String getSelectedCourseCode() { return selectedCourseCode.get(); }
	
	
/* by subject related */
	public ListProperty<String> subjectsProperty() { return subjects; }
	public ObjectProperty<String> selectedSubjectProperty() { return selectedSubject; }
	public ListProperty<String> sectionsProperty() { return sections; }
	public ObjectProperty<String> selectedSectionProperty() { return selectedSection; }
	// a specific sub-topic
	public ListProperty<String> subSectionsProperty() { return subSections; }
	public ObjectProperty<String> selectedSubSectionsProperty() { return selectedSubSection; }
	
	public String getSelectedSubjectProperty() {return selectedSubject.get(); }
	public String getSelectedSectionProperty() { return selectedSection.get(); }
	public String getSelectedSubSectionProperty() { return selectedSubSection.get(); }
