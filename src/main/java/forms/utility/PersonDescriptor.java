...
public abstract class PersonDescriptor implements Descriptor<EncryptedPerson> {
      ...
      public StringProperty origEmailProperty() {
            return origEmail;
      } // in MetaParent
      ...
      public StringProperty photoLinkProperty() {
            return photoLink;
      }
