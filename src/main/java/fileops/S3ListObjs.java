...
public class S3ListObjs {
    ...
    private ArrayList<CloudLink> cloudLinks;
     ...
     * @param pw
     */
    public void listDecks(String name, String pw) {
        ...
        String json = new String("{" +
                "\"username\":\"" + name + "\"" +
                ",\"password\":\"" + pw + "\"}");
        String destination = "deck-s3-list";
    ...
    private void listObjsHelper(String json, String destination) {
    ...
    private void setCloudLinks(ArrayList<String> elements) throws JsonProcessingException {
        ...
        // get response and parse into maps
