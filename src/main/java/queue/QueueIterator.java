...
public class QueueIterator<E> implements Iterator<E> {
       ...
       * pre-condition index references the next element to access.
       * post-condition: index and count are incremented.
       *
