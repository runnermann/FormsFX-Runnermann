...
public class TextCell
{
    ...
    private final StyledArea textArea = new StyledArea();
    ...
    public TextCell() {
        ...
        textCellVbox.setPadding(new Insets(6, 4, 4, 4));
...
//        return buildCell(txt, prompt, SceneCntl.instance().getCenterWd(), SceneCntl.instance().calcCellHt(), 2, isEqual, otherHt);
//    }
 ...
 //       textArea.setText(txt);
    ...
    public final StyledArea getTextArea()
    {
