...
import richtextfm.model.StyledDocument;
...
import video.camera.MacCameraCapture;
...
public class SectionEditor {
    ...
    // The editor object for this SectionEditor
    private final EditorMain textEditorMain;
    // The FlashMonkey instantiation of the RichTextEditor.
    // Use the TextAreaStyled. Each SectionEditor
    // owns their TextAreaStyled. This allows multiple
    // editors to be instantiated at the same time.
    private StyledArea rtTextArea;
    ...
    public SectionEditor() {
        this.rtTextArea = new StyledArea();
        this.textEditorMain = new EditorMain(rtTextArea);
    ...
    public SectionEditor(String prompt, char qOrA, String cID) {
        ...
        this.txtVBox = new VBox(textEditorMain.getEditorVBox());
        ...
        rtTextArea.setOnKeyPressed(e -> CreateFlash.getInstance().setFlashListChanged(true));
        rtTextArea.setOnMouseDragged(e -> CreateFlash.getInstance().setFlashListChanged(true));
        rtTextArea.setPadding(new Insets(4, 4, 4, 0));
    ...
    public final EditorMain getTextEditor() {
        return this.textEditorMain;
    }
 ...
 //       tCell.getTextArea().setText("");
    ...
    *****************************************************************************/
    ...
    public String[] getMediaFileNames() {
        LOGGER.info(" **** called getMediaFileNames() ****" + "\nmediaFileName: " + mediaFileName + "    |      shapesFile: " + shapesFileName);
        if(this.arrayOfFMShapes.size() > 1) {
            String[] s = {mediaFileName, shapesFileName};
            return s;
        }
        else {
            String[] s = {mediaFileName};
            return s;
        }
    }
    ...
    /**
     * Returns the styled text from the textCell stylableTextArea.
     * Convienience method.
     * @return ..
     */
    public StyledDocument<ParStyle, Either<String, Hyperlink>, TextStyle> getStyledText()
    {
//        return this.textEditor.getTextArea().getText();
        return this.rtTextArea.getDocument();
    }

    public String getPlainText() {
        return this.rtTextArea.getText();
    }
 ...
 //       this.textEditor.getTextArea().setStyle("-fx-prompt-text-fill: rgba(0,0,0,.5); ");
    }
...
//        this.textEditor.getTextArea().setStyle("-fx-prompt-text-fill: rgba(f,f,f,1); ");
    }
    ...
    /**
     * Sets the text in the textCells StylableTextArea.
     * Convienience method
     * @param text ..
     */
    public void setTextUnformatted(String text) {
        // @TODO Finish setTextUnformatted in SectionEditor line 772
 //       this.rtTextArea.
 //       this.tCell.getTextArea().setText(text);
    }

    /**
     * Appends unformatted text to the text area
     * @param text
     * @TODO Verify setText in SectionEditor with new stylableTextArea
     */
    public void setText(String text) {
        // @TODO Finish setText in SectionEcitor
        this.rtTextArea.appendText(text);
    }
    ...
    public void setPrompt(String text) {
        // @TODO Finish setPrompt in SectionEditor
 //       this.rtTextArea.get
...
//        textEditor.getTextArea().setPrefHeight(num - 150);
//        textEditor.getTextCellVbox().setPrefHeight(num - 125);
        ...
        switch(mediaType) {
            ...
            case 'd':
            {
                ...
                FileOpsShapes fo = new FileOpsShapes();
                this.arrayOfFMShapes = fo.getListFromPath(shapesPath);
                ...
                this.rightPane.setOnMouseClicked(e -> {
                    ...
                    edPopup.shapePopupHandler(this.arrayOfFMShapes, this, shapesPath, deckName, cID, qOrA);
                });
            ...
            case 'm':
            {
                ...
                LOGGER.debug("media rightPane isEmpty: " + rightPane.getChildren().isEmpty());
...
//        textEditor.getTextArea().setStyle("-fx-text-fill: RED");
    }
...
//        textEditor.getTextArea().setStyle("-fx-text-fill: BLACK");
    }
...
//    private FileNaming fileNaming;
    ...
    public void snapShotBtnAction() {
        ...
        DirectoryMgr dirMgr = new DirectoryMgr();
        String path = dirMgr.getMediaPath('C');
    ...
    private class DragAndDrop {
        ...
        private void dragDropped(DragEvent e) {
            ...
            if ( ! dNdIsdisabled) {
                ...
                if (dragboard.hasImage()) {
                    ...
                    //ending = ending.equals("gif") ? ".gif" : ".png";
                ...
                if(isCompleted) {
                    ...
                    if(shapesFileName != null) {
                        ...
                        mediaFileNames[0] = mediaFileName;
                        mediaFileNames[1] = shapesFileName;
                    }
                    else {
        ...
        private String saveImage(Image image, String mime, String deckName) {
            ...
            if(!bool) {
                ...
                mediaFileName = fileNaming.getMediaFileName();
            }
            ...
            if(FileOpsUtil.folderExists(new File(mediaPath)))
            {
                ...
                if(mediaType == 'M') {
                    try {
                        ...
                        mediaFileName = FileNaming.getVideoName(cID, getQorA(), ending);
                    ...
                    if (800 < image.getHeight() || 800 < image.getWidth()) {
                        ...
                        try {
                            ...
                            shapesFileName = FileNaming.getShapesName(mediaFileName);


                            targetImg = Paths.get(mediaPath + mediaFileName);
...
//        Bounds bounds = textEditor.getTextArea().getLayoutBounds();
//        return textEditor.getTextArea().localToScreen(bounds.getMinX() + 40, bounds.getMinY() + 40);
        //@TODO finish getTExtAreaXY

        return new Point2D(100.0, 100.0);
    }
