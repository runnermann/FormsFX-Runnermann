...
public class LetterBuilder extends GenericBuilder<FMLetter, LetterBuilder> {
      ...
      protected Shape editableShapeAction(Shape fxText, GenericShape gs) {
            ...
            fxText.setOnMouseClicked(f -> shapeClicked(f, gs, fxText));
            fxText.setOnMousePressed(f -> shapePressed(f, gs, fxText));
            fxText.setOnMouseDragged(f -> shapePressed(f, gs, fxText));
            fxText.setOnMouseReleased(f -> shapeReleased(f, gs, fxText));
