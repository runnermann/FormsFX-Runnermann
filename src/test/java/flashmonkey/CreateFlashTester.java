...
//	@Test
//	@Order(1)
//	public void checkTextInEditorUisTrue() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
//		setUp();
//		// check if card shows has data in upper editor. should return 1
//		editorU.tCell.getTextArea().setText(bla);
//
//		// USING REFLECTION TO TEST PRIVATE METHOD
//		Method method = EncryptedAcct.class.getDeclaredMethod("checkContent", String.class, String.class, String.class);
//		method.setAccessible(true);
//		// *** NOTE THAT the first object is THE OBJECT OF THE TESTED CLASS THAT THE METHOD BELONGS TO. *** //
//		int result = (int) method.invoke(editorU, editorL);
//
...
//		setUp();
//		// check if card shows has data in lower editor. should return 1
